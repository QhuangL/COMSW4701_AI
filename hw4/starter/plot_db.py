...
if __name__ == "__main__":
    ...
    data = pd.read_csv('data_n.csv', header=None, names = ['Age', 'Weight', 'Height'])

    # # Note, these weights just happen to look good.
    # visualize_scatter(data, weights=[-5, -2, 39])
    ...
    lin_reg_weights = [1.09646081, 0.12943908, 0.00141145]

    visualize_3d(df, lin_reg_weights=lin_reg_weights,
                 feat1='Age', feat2='Weight', labels='Height', zlim=(0.4, 1.8), alpha = 0.8,
